...
export default function Footer() {
  return (
    <footer className="bg-[#1d5f4c] text-white py-14 shadow-md">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6 items-center">
